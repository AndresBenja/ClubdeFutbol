package com.example.clubdefutbol.viewmodels
...
class ClubdeFutbolViewModel:ViewModel(){

    private val mutablelclubdeFutbol= MutableLiveData<MutableList<ModeloJugadores>>()
    val clubdefutbol_ld: LiveData<MutableList<ModeloJugadores>>
        get() = mutablelclubdeFutbol

    init {
        mutablelclubdeFutbol.value=getFakeListado()
    }
